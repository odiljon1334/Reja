function removeItem(item, removeable) {
    const updated = [];
    for(let i = 0; i < item.length; i++) {
        if (item[i] !== removeable) {
            updated.push(item[i]);
        }
    }
    return updated
...
// const item = {
//     inventory: 5,        // oddiy narx uchun inventar soni
//     price: 100,           // oddiy narx
//     salePrice: 10,        // aksiya narxi
//     saleInventory: 2      // aksiya inventar soni
// };
...
// console.log(`Eng arzon narx: $${lowestPrice}`);
